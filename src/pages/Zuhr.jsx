...
const Zuhr = () => {
    return (
        <div className='prayer-content'>
            <h5 className='light-brown d-inline-block'>Niyyah/ Making Intention</h5>
            <p>Allaahu Akbar</p>
            ...
            <div>
                ...
                <p> <span className='light-brown d-inline-block me-2'>Ruku:</span><br />
                    ...
                    Allaahumma salli 'alaa Muhammadin wa Aali Muhammad</p>
                <p> <span className='light-brown d-inline-block me-2'>start standing:</span><br />
                    Sami'allaahu liman hamidah</p>
                <p>Allaahu Akbar</p>
                <p><span className='light-brown d-inline-block me-2'>Sajda:</span><br />
                    Subhaana rabbiy al-a'laa wa bihamdih <br />
                    Allaahumma salli 'alaa Muhammadin wa Aali Muhammad</p>
                <p><span className='light-brown d-inline-block me-2'>sit:</span><br />
                    Allaahu Akbar <br />
                    Astaghfirullaaha rabbee wa atoobu ilayh <br />
                    Allaahu Akbar</p>
                <p><span className='light-brown d-inline-block me-2'>Sajda:</span><br />
                    Subhaana rabbiy al-a'laa wa bihamdih <br />
                    Allaahumma salli 'alaa Muhammadin wa Aali Muhammad</p>
                ...
                <p><span className='light-brown d-inline-block me-2'>start standing:</span><br />
                    Bihawlillaahi wa quwwatihi aqoomu wa aq'ud</p>
            </div>
            ...
            <div>
                ...
                <p><span className='light-brown d-inline-block me-2'>Qunoot:</span><br />
                    ...
                    Allahum Maghfirlee wali walidayya<br />
                    wa lil-mu'mineena wal mu'minaat <br />
                    wal muslimeena wal muslimaat. <br />
                    Allaahumma salli 'alaa Muhammadin wa Aali Muhammad</p>
                <p>Allaahu Akbar</p>
                <p><span className='light-brown d-inline-block me-2'>Ruku:</span><br />
                    Subhaana rabbi al-'azeemi wa bi'hamdih <br />
                ...
                <p><span className='light-brown d-inline-block me-2'>sit:</span><br />
                    ...
                    Allaahumma salli 'alaa Muhammadin wa Aali Muhammad <br /><br />
                </p>
                <p><span className='light-brown d-inline-block me-2'>start standing:</span><br />
                    Bihawlillaahi wa quwwatihi aqoomu wa aq'ud</p>
            </div>
            ...
            <div>
                ...
                <p><span className='light-brown d-inline-block me-2'>sit:</span><br />
                    ...
                    wa ash'hadu anna muhammadan 'abduhu wa rasuluh <br />
                    Allaahumma salli 'alaa Muhammadin wa Aali Muhammad <br /><br />
                    <span className='light-brown d-inline-block me-2'>Salaam:</span> <br />
                    Assalamu 'alayka ayyuhan nabiyyu wa rahmatullaahi wa barakaatuh. <br />
                    Assalamu 'alaynaa wa'allah ibaadillah hiss'saaliheen. <br />
                    Assalamu 'alaykum wa rahmatullaahi wa barakaatuh. <br />
                    Allaahu Akbar <br />
                    Allaahu Akbar <br />
                    Allaahu Akbar <br />
                </p>
                ...
                <h5 className='light-brown d-inline-block'>Make Dua</h5>
            </div>
